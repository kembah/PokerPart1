...
public class Hand {
	...
	public void EvalHand() {
		...
		//Sort the suits!!!!!! - not sure if we need this...we changed something in Card.java 
		Collections.sort(CardsInHand, Card.CardSuit);
		...
		// Flush
					...
					.get(eCardNo.FifthCard.getCardNo()).getSuit()) {
					ScoreHand(eHandStrength.Flush,CardsInHand.get(eCardNo.FirstCard.getCardNo()).getSuit().getSuit(), 0, 0);
			}
